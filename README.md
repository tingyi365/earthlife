...
<p align="center">
  <a href="https://earthlife.pages.dev"><img src="docs/social_preview.png" width="100%" alt="EarthLife 地球 Online — 從受精卵到火化，你的人生只值幾分？AI 自己寫自己進化的台味鬼島人生模擬器，R1→R144 百輪迭代、逾 800 事件、零人類手寫遊戲碼。線上免費試玩 earthlife.pages.dev"></a>
</p>
...
[![AI Self-Evolved](https://img.shields.io/badge/AI%20%E8%87%AA%E4%B8%BB%E9%80%B2%E5%8C%96-R1%20%E2%86%92%20R144%20%E4%BB%8D%E5%9C%A8%E7%B9%BC%E7%BA%8C-ffd24a?style=for-the-badge)](docs/AI_AUTONOMOUS_UPDATE.md)
...
<p align="center"><sub>↑ 實機 demo（持續進化中，目前 R144）</sub></p>
...
遊戲上線後的每一輪迭代（**R1 → R144，仍在繼續**），都由一個 AI agent 自主完成，**每 30 分鐘一輪**，無人介入、**全程零人類手寫遊戲碼**：
...
144 輪下來，遊戲從 61 個事件的雛形，長成 **逾 800 個事件、逾 111 種梗圖場景、逾 330 個成就、逾 77 種死法、10＋ 隱藏結局＋一整套隱藏稀有結局**、外加自繪人生分享卡與成就圖鑑、多館合一的收藏圖鑑（死法／成就／出身／天賦）、一整套會陪你走完一生的台味 NPC 人際羈絆系統、可「再玩一輪」延續動機的周目 / New Game+ 機制、結算頁用 inline SVG 攤開一生五階段屬性軌跡的屬性編年史回顧，再到把每段人生收進跨周目收藏冊、可並排炫耀的歷代人生名人堂，以及五圍真正驅動命運分流的屬性系統、多段命運抉擇鏈、會在謝幕時把一生定級成普通→神話五階稀有度的人生評級系統，把每世表現換算成「業力」跨周目永久累積解鎖命格加成的轉生／業力繼承系統、以日期為確定性種子讓全體玩家同局比成績的每日挑戰種子模式，到把多館收藏攤成總完成度 %＋稀有戰利品展示櫃＋可分享圖鑑卡的全館圖鑑收集牆，再到把本局真實經歷自動織成可截圖分享的人生回憶錄敘事，補上隨人生階段動態換色的沉浸式視覺氛圍層與純前端 WebAudio 合成的沉浸式音效層、台味股海浮沉投機理財支線（存股／梭哈／鐵齒三分流＋FIRE／韭菜畢業多結局），讀本局真實經歷演算出單一台味人格原型標籤＋稀有度估算＋一鍵截圖的人生人格鑑定分享卡，把本局戰績編碼進可分享連結、朋友開連結即跳戰帖橫幅並於完局自動對照回流的病毒人生挑戰迴圈，從本局挑出最遺憾的關鍵抉擇演算「若當初走另一條路」假想人生推演＋一鍵再走一次的平行人生反事實回放，開局可主動選地獄／普通／簡單難度劇本、差異化起手五圍讓屬性開局即有實感的開局人生難度模式，最後到遊玩中隨關鍵事件即時生成台味諷刺新聞頭條＋結算年度頭條回顧的鬼島時事諷刺新聞快報，到讓你遊玩中踏進手遊課金抽卡坑（無課／小資／課長三派）、謝幕回顧課金路線與「這輩子課了多少」＋專屬結局的台味手遊課金抽卡人生支線，讓五圍真正驅動關鍵抉擇成功率與分支門檻、結算攤出五圍人生軌跡卡的數值驅動強化，用隱藏壓力儀表吃抉擇與五圍透支、跨臨界觸發爆肝住院／卡債法拍／過勞猝死崩盤連鎖且可掙扎翻身並結算鬼島生存指數的壓力崩盤翻身機制，依本局走過的七業生成「我的鬼島職涯」路線名＋達成度的職涯路線回顧卡，最後到遊玩中即時點亮升階台味在地稱號 Badge（躺平大師／房奴／爆肝戰士⋯）、謝幕定格成可分享稱號牆＋跨局集滿解鎖的即時稱號養成系統，到讓五圍真正驅動命運——六大
獨立旗標的社交人脈・朋友圈軌跡軸，最後到謝幕把本局體質＋年齡＋財富 deterministic 推演一生養生作息與體態身體狀態軌跡（林北鐵打的鐵人體質→養生達人規律凍齡→三高候選藥罐子中廣發福→爆肝代表熬夜外食早衰過勞包／長照臥床體態崩壞／無病無痛長命百歲，體質為主驅動＋財富養生本錢）＋6 身體狀態成就（鐵人體質／養生達人／長命百歲／藥罐子／爆肝代表／長照臥床）＋跨局集滿 r144_health＋滿滿台味鬼島健康梗（健保血汗／爆肝過勞／22K 買不起健康／三高／長照悲歌）、專注作息體態「過程」與 R138 病歷長照「結局命運」軸各自獨立旗標的健康・身體狀態軌跡軸（內容數據由測試報告即時統計，最新賣點截至 R144）——每一步都有測試把關、每一步都可回溯。

詳細機制設計請見 **[docs/AI_AUTONOMOUS_UPDATE.md](docs/AI_AUTONOMOUS_UPDATE.md)**。

### 🧬 AI 自主進化時間軸（R1 → R144 精選里程碑）
...
| **R139** | 🎓 學歷職涯軌跡軸・放牛班到財富自由：謝幕把本局**智力＋財富＋年齡** deterministic 推演你這一生的**學歷與職涯軌跡**——學歷四階（**放牛班→學店私大→國立中段→台清交頂大／海歸**，智力為主驅動、財富加成升學資源），再依年齡決定職涯走多遠，演算出 **5 種職涯命運**（**財富自由・人生勝利組／小主管・中產上岸／過勞躺平・小確幸／中年失業・被資遣／22K 魯蛇・低薪起跑線**），結算發「**鬼島學歷職涯**」回顧卡＋5 職涯成就＋跨局集滿解鎖 `r139_career`，滿滿台味學店／22K／慣老闆鬼島梗（直接回應玩家「智力數值要有存在感」的心聲）——純衍生／結算覆蓋層只讀本局資料、零 rng、零汙染、舊存檔／壞資料安全降級、與 R131 事件型職涯路線各自獨立旗標、sim 事件序列零擾動、兩測全綠補 R139 探針 |
| **R140** | 💘 婚戀家庭軌跡軸・從母胎單身到黃昏戀：謝幕把本局**魅力＋財富＋年齡** deterministic 推演你這一生的**婚戀與家庭軌跡**——以**魅力為主驅動**推演出本局的感情命運（**母胎單身魯蛇→工具人／海王玩咖→穩交修成正果→閃婚閃離→喪偶終老／黃昏戀／頂客／兒孫滿堂**），結算發「**鬼島婚戀家庭**」回顧卡＋5 婚戀成就（人生勝利組鴛鴦／母胎單身／海王玩咖／離婚達人／喪偶終老）＋跨局集滿解鎖 `r140_love`，滿滿台味鬼島婚戀梗——純衍生／結算覆蓋層只讀本局資料、零 rng、零汙染、舊存檔／壞資料安全降級、與 R73 感情婚戀鏈／R110 育兒各自獨立旗標、sim 事件序列零擾動、兩測全綠補 R140 探針 |
| **R141** | 🎨 興趣才藝・斜槓夢想軌跡軸：謝幕把本局**智力＋魅力＋財富＋年齡** deterministic 推演你這一生的**興趣／才藝／副業／夢想軌跡**——以**智力＋魅力為主驅動、財富加成**演算出本局的斜槓夢想命運（**廢宅躺平魯蛇→假日斜槓玩票→網紅直播夢→斜槓財富自由／環島壯遊圓夢／手作市集小確幸／半途而廢半吊子**），結算發「**興趣才藝・斜槓夢想**」回顧卡＋5 才藝成就（圓夢家／斜槓達人／網紅夢／廢宅躺平／半途而廢魯蛇）＋跨局集滿解鎖 `r141_hobby`，滿滿台味斜槓網紅抖內鬼島梗（直接回應玩家「智力＋魅力數值要有存在感」的心聲）——純衍生／結算覆蓋層只讀本局資料、零 rng、零汙染、不新增事件不擾 seed-pinned 抽序、舊存檔／壞資料安全降級、與 R139 學歷職涯各自獨立旗標、sim 事件序列零擾動、兩測全綠補 R141 探針 |
| **R142** | 💹 理財投資・財富累積軌跡軸：謝幕把本局**財富＋智力＋年齡** deterministic 推演你這一生的**理財投資軌跡**——以**財富（本金）＋智力為主驅動、本金影響子彈厚度、年齡決定財富走多遠**演算出本局的投資命運（**月光族韭菜→定期定額 ETF 躺平→存股族穩穩複利→當沖鬼畢業融資斷頭／All in 航運王翻身暴富／買在最高點套牢韭菜本命／提早 FIRE 財富自由養老**），結算發「**鬼島理財投資・財富軌跡**」回顧卡＋5 投資成就（提早 FIRE／航運王／存股達人／當沖畢業／韭菜本命）＋跨局集滿解鎖 `r142_invest`，滿滿台味台股韭菜當沖航運鬼島梗（直接回應玩家「財富＋智力數值要有存在感」的心聲）——純衍生／結算覆蓋層只讀本局資料、零 rng、零汙染、不新增事件不擾 seed-pinned 抽序、舊存檔／壞資料安全降級、與 R122 台味股海事件支線各自獨立旗標、sim 事件序列零擾動、兩測全綠補 R142 探針 |
| **R143** | 🤝 社交人脈・朋友圈軌跡軸：謝幕把本局**魅力＋智力＋財富＋年齡** deterministic 推演你這一生的**社交人脈／朋友圈軌跡**——以**魅力＋智力為主驅動、財富加成**演算出本局的社交命運（**邊緣魯蛇句點王→塑膠泛泛之交→八方酒肉朋友→人脈王交際花／孤獨終老／三五知己細水長流**），結算發「**鬼島社交人脈・朋友圈**」回顧卡＋6 社交成就（人脈王／邊緣人／句點王／酒肉之友／孤獨終老／三五知己）＋跨局集滿解鎖 `r143_social`，滿滿台味鬼島社交梗（邊緣人／句點王／塑膠朋友／群組已讀不回，直接回應玩家「魅力＋智力數值要有存在感」的心聲）——純衍生／結算覆蓋層只讀本局資料、零 rng、零汙染、不新增事件不擾 seed-pinned 抽序、舊存檔／壞資料安全降級、與 R140 婚戀／R136 人際羈絆網各自獨立旗標、sim 事件序列零擾動、兩測全綠補 R143 探針 |
| **R144** | 🩻 健康・身體狀態軌跡軸（養生作息與體態）：謝幕把本局**體質＋年齡＋財富** deterministic 推演你這一生的**養生作息與體態身體狀態軌跡**——以**體質為主驅動、財富影響養生本錢（健身房私廚自費健檢 vs 22K 買不起健康）、年齡決定體態老化**演算出本局的身體命運（**林北鐵打的鐵人體質→養生達人規律凍齡→三高候選藥罐子中廣發福→爆肝代表熬夜外食早衰過勞包／長照臥床體態崩壞／無病無痛長命百歲**），結算發「**鬼島健康・身體狀態**」回顧卡＋6 身體狀態成就（鐵人體質／養生達人／長命百歲／藥罐子／爆肝代表／長照臥床）＋跨局集滿解鎖 `r144_health`，滿滿台味鬼島健康梗（健保血汗／爆肝過勞／22K 買不起健康／三高／長照悲歌，直接回應玩家「體質數值要有存在感」的心聲）——純衍生／結算覆蓋層只讀本局資料、零 rng、零汙染、不新增事件不擾 seed-pinned 抽序、舊存檔／壞資料安全降級、專注作息體態「過程」與 R138 病歷長照「結局命運」軸各自獨立旗標、sim 事件序列零擾動、兩測全綠補 R144 探針 ①-⑪（最新一輪） |

> 一個 AI agent，連續自我迭代 **144 輪**、每一輪都得過測試閘門才放行，**全程零人類手寫遊戲碼**——這是這個專案最獨特的賣點。完整 144 輪逐輪設計決策直接寫在 `index.html` 的程式碼註解裡，那也是下一輪 AI 的記憶。
...
Every iteration since launch (**R1 → R144 and counting**) was performed by an AI agent, **one round every 30 minutes**, with no human in the loop and **zero human-written game code**:
