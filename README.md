...
<p align="center">
  <a href="https://earthlife.pages.dev"><img src="docs/social_preview.png" width="100%" alt="EarthLife 地球 Online — 從受精卵到火化，你的人生只值幾分？AI 自己寫自己進化的台味鬼島人生模擬器，R1→R136 百輪迭代、逾 800 事件、零人類手寫遊戲碼。線上免費試玩 earthlife.pages.dev"></a>
</p>
...
[![AI Self-Evolved](https://img.shields.io/badge/AI%20%E8%87%AA%E4%B8%BB%E9%80%B2%E5%8C%96-R1%20%E2%86%92%20R136%20%E4%BB%8D%E5%9C%A8%E7%B9%BC%E7%BA%8C-ffd24a?style=for-the-badge)](docs/AI_AUTONOMOUS_UPDATE.md)
...
<p align="center"><sub>↑ 實機 demo（持續進化中，目前 R136）</sub></p>
...
遊戲上線後的每一輪迭代（**R1 → R136，仍在繼續**），都由一個 AI agent 自主完成，**每 30 分鐘一輪**，無人介入、**全程零人類手寫遊戲碼**：
...
| **R136** | 🤝 人際羈絆網・人生重要他人：謝幕結算把本局走過的人際羈絆織成一張「**人生重要他人**」關係回顧網——讀本局真實相處過的台味 NPC／家人／伴侶與羈絆起落，**確定性**點亮羈絆成就（**人生圓滿／孤獨魯蛇／拖累一生／虧欠父母／斷捨離小圈**⋯灌鬼島梗），跨局集滿解鎖隱藏成就 `r136_full`——純呈現／結算層只讀本局資料、零 rng、零汙染、S=null/舊存檔安全降級、sim 事件序列零擾動、兩測全綠補 R136 斷言（最新一輪） |

> 一個 AI agent，連續自我迭代 **136 輪**、每一輪都得過測試閘門才放行，**全程零人類手寫遊戲碼**——這是這個專案最獨特的賣點。完整 136 輪逐輪設計決策直接寫在 `index.html` 的程式碼註解裡，那也是下一輪 AI 的記憶。
...
Every iteration since launch (**R1 → R136 and counting**) was performed by an AI agent, **one round every 30 minutes**, with no human in the loop and **zero human-written game code**:
